...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO pasien (nama_pasien, jk_pasien, notelp_pasien, alamat_pasien, usia, tgl_lahir, status, nm_kk, hubungan_keluarga) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data pasien berhasil ditambahkan.'); window.location.href='data-pasien.php';</script>";
    } else {
    ...
    <div class="wrapper">
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <input type="text" id="notelp_pasien" name="notelp_pasien" placeholder="No-telepon" maxlength="11" required>

                <label for="usia">Usia:</label>
                <input type="number" id="usia" name="usia" placeholder="Usia" required>

                <label for="alamat_pasien">Alamat:</label>
                <input type="text" id="alamat_pasien" name="alamat_pasien" placeholder="Alamat rumah" required>
                ...
                <label for="no_kk">Nama Kepala Keluarga:</label>
                <input type="text" id="nm_kk" name="nm_kk" placeholder="Nama" maxlength="11" required>

                <label for="hubungan_keluarga">Hubungan Keluarga:</label>
                <input type="text" id="hubungan_keluarga" name="hubungan_keluarga" placeholder="Hubungan" required>
